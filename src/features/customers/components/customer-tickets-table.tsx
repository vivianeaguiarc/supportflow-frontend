...
/**
 * Tabela de chamados de um cliente — reutiliza o DataTable genérico e as colunas
 * de tickets, forçando o filtro server-side `customerId`. Paginação, ordenação,
 * filtros e navegação para o detalhe funcionam exatamente como em `/tickets`.
 */
export function CustomerTicketsTable({
  customerId,
}: CustomerTicketsTableProps) {
  const {
    pagination,
    sorting,
    setPagination,
      ...
      <DataTable
        ...
        emptyState={{
          title: hasActiveFilters
            ...
            : "Este cliente ainda não possui chamados",
